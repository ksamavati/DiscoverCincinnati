...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="d-flex flex-row justify-content-evenly align-items-center text-center flex-wrap py-2"
      style={{ backgroundColor: "#eef0ef" }}
    >
      <div className="flex-person ms-3">
        This website was built as the final capstone project of a group of 3
        students who have graduated from Kable Academy's full-stack web
        development program in September 2022.
      </div>
      ...
      <div className="flex-person me-3">
        <h5 className="py-4" style={{ verticalAlign: "middle" }}>
          <Link to="/team">
            Learn more about us{" "}
