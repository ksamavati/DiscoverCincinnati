              ...
              >
                <div className="card-body p-4">
                  ...
                  <div className="card-text pt-1 text-center">
                    ...
                    <div className="mb-3">
                      Frontend specialist and Content Manager
                    </div>
                    <div>
                      Passionate about front-end development. Always looking to
                      improve her skills.
                    </div>
                  </div>
                </div>
                ...
                <div className="card-footer theme-bg-primary border-0 text-center">
                  <ul className="social-list list-inline mb-0 mx-auto d-flex flex-row justify-content-center align-items-center">
                    <li className="list-inline-item">
                      <a
                        className="text-dark"
                        href="https://github.com/Bigracksvee"
                      >
                    ...
                    <li className="list-inline-item">
                      <a
                        className="text-dark"
                        href="https://www.linkedin.com/in/vera-opoku-302437244/"
                      >
              ...
              >
                <div className="card-body p-4">
                  <div className="member-profile position-absolute w-100 text-center">
                    <img
                      className="rounded-circle mx-auto d-inline-block shadow-sm"
                      src="/assets/img/avatars/kayvon.svg"
                      alt="Kayvon"
                    />
                  </div>
                  <div className="card-text pt-1 text-center">
                    ...
                    <div className="mb-3 text-center">
                      Project Lead and Backend Specialist
                    </div>
                    <div>
                      Automation fanatic and eternal student. Code monkey by day
                      and swole code gorilla by night.
                    </div>
                  </div>
                </div>
                {/* <!--//card-body--> */}
              ...
              >
                <div className="card-body p-4">
                  ...
                  <div className="pt-1">
                    ...
                    <div className="mb-3 text-center">
                      Database Architect and VFX Specialist
                    </div>
                    <div className="text-center">
                      Enjoys stirring up innovation with creative artistry,
                      vision, flair and functionality to deliver results that
                      reflect technological goals and ideas in a clear and
                      concise manner.
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="card-body p-4">
                  ...
                  <div className="card-text pt-1 text-center">
                    ...
                    <div>
                      Coffee addict and avid proponent of blockchain tech. In
                      his free time he enjoys long walks on the beach and
                      explaining development fundamentals to aspiring web
                      developers.
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="card-body p-4">
                  ...
                  <div className="card-text pt-1 text-center">
                    ...
                    <div>
                      Future game developer and Ramen bowl consumer. Atomic
                      makeup primarily composed of tonkotsu and pure liquid Nos
                      biofuel. Ask him about Outer Wilds. Seriously.
                    </div>
                  </div>
                </div>
                {/* <!--//card-body--> */}
