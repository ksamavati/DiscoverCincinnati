				...
				<section className="home-section">
					<div className="container text-center">
						...
						<div className="row pt-4" data-aos="fade-left" data-aos-delay="100">
							...
							{pageLoaded && <div className="col-md-6" data-skyscanner-widget="SearchWidget" data-origin-geo-lookup="true" data-destination-name="Cincinnati" data-flight-type="return"
								data-iframe="true" style={{ minWidth: '160px', maxWidth: '500px' }}></div>}
						</div>
					</div>
